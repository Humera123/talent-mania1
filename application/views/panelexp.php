...
<h3>Experience:</h3><br />  
           ...
           ?>  
                <tr>  
                     ...
                     <td><a href="<?php echo base_url() . "paneldashboard/delete_exp_data/" . $row->panelexpid; ?>">Delete</a></td>  
                     <td><a href="<?php echo base_url() . "paneldashboard/edit_exp_data/" . $row->panelexpid; ?>">Edit</a></td>  
                </tr>  
           <?php       
                }  
           }  
      ...
      if($exp)
      {
        ...
        {
        ?>
         <?php echo form_open('paneldashboard/update_exp_data', array('id' => 'panel_exp')) ?>   
          ...
          <p><input type="checkbox" name="current_job"  class="form-control" onclick="myFunction()"> Current Job
    ...
    <span class="text-danger"><?php echo form_error('current_job'); ?></span></p>
    <input type="submit" name="submit" value="Add Experience" class="btn btn-info" onclick="submitForm('http://talent-mania.com/paneldashboard/validation_exp')" />
    <input type="submit" name="next" id="next" value="Next" class="btn btn-info"  onclick="submitForm('http://talent-mania.com/paneldashboard/totalexperience')"/>

    
 
</form>
<img id="loadingimg" src="<?php echo base_url().'images/giphy.gif' ?>" style="display: none;">
...
function submitForm(action) {
    var form = document.getElementById('panel_exp');
    form.action = action;
    form.submit();
  }
</script>