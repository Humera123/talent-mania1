...
<h3>Education:</h3><br />  
           ...
           ?>  
                <tr>  
                     ...
                     <td><a href="<?php echo base_url() . "paneldashboard/delete_edu_data/" . $row->educationid; ?>">Delete</a></td>  
                     <td><a href="<?php echo base_url() . "paneldashboard/edit_edu_data/" . $row->educationid; ?>">Edit</a></td>  
                </tr>  
           <?php       
                }  
           }  
      ...
      if($edu)
      {
        ...
        {
        ?>
<?php echo form_open('welcome/update_edu_data', array('id' => 'panel_edu')) ?> 
    ...
    <p><label>End Date :</label>&nbsp&nbsp&nbsp<input placeholder="End Month..." type="date" name="end_month_edu" class="form-control" id="end_month_edu"value="<?php echo set_value('end_month_edu'); ?>" />
...
<?php echo form_close() ?>
    ...
    <input type="submit" name="submit" value="Add Experience" class="btn btn-info" onclick="submitForm('http://talent-mania.com/paneldashboard/validation_edu')" />
    <input type="submit" name="next" id="next" value="Next" class="btn btn-info"  onclick="submitForm('http://talent-mania.com/paneldashboard/skill')"/>
  </form>
...
function submitForm(action) {
    var form = document.getElementById('panel_edu');
    form.action = action;
    form.submit();
  }
