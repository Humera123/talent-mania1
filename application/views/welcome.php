 <br /><br /><h3 align="center">Welcome to Talent Mania</h3>
...
<?php
 ...
 <?php 
  ...
  {
  ?>
   <p class="float-left"><label>Upload Latest Degree Image:</label>
  ...
  <img name="lastdegreeimg" id="lastdegreeimg" width="100"alt="Upload Latest Degree Image" /></p>
